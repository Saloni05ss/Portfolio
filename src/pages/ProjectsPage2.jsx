...
export const ProjectsPage2 = React.forwardRef(({ onNext, onPrev, page, totalPages }, ref) => {
  ...
  const features = [
    'Developed the mobile application for a Hotel Customer Management System, supporting both individual hotels and hotel groups.',

'Implemented mobile-friendly UI/UX and API integrations for bookings, customers, and hotel operations.',

'Optimized workflows for hotel staff with role-based access, dashboards, and real-time updates.'
  ];
